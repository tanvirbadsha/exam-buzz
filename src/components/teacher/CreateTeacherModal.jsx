...
export function CreateTeacherModal({ isOpen, onClose, onCreate }) {
  useEffect(() => {
  ...
  return (
    ...
    >
      <button
        ...
        aria-label="Close create teacher modal"
        onClick={onClose}
      />
      <div className="relative w-full max-w-3xl overflow-hidden rounded-lg border border-border bg-surface shadow-2xl">
        <div className="flex items-start justify-between gap-4 border-b border-border px-5 py-4">
          <div>
            ...
            <p className="mt-1 text-sm text-muted">
              Add a teacher account for exam assessment work.
            </p>
          </div>
          <button
            type="button"
        ...
        <div className="p-5">
          <TeacherForm
            ...
            onSubmit={(teacherInput) => {
              onCreate(teacherInput);
              onClose();
            }}
            secondaryAction={
              <button
